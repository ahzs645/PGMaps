...
export type AnalysisInput = {
  ...
  targets: Array<Pick<TargetPolygon, 'id' | 'name' | 'role' | 'geometry' | 'harvestYear' | 'clearcutPercent' | 'siteDisturbance' | 'recoveryPercent'>>
...
export type AnalysisResult = {
  ...
  renderStands?: Array<{ geometry: GeoJSON.Polygon | GeoJSON.MultiPolygon; heightMeters: number; crownClosurePercent: number | null; speciesCode?: string | null }>
}
