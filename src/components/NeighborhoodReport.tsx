...
export function NeighborhoodReport({ lat, lng, onClose }: NeighborhoodReportProps) {
  ...
  return (
    <div className="absolute bottom-20 left-4 z-30 w-80 overflow-hidden rounded-xl border border-border bg-background/95 shadow-2xl backdrop-blur md:bottom-6 md:left-auto md:right-72">
