    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          <div className="text-[11px] text-violet-800/80 dark:text-violet-200/80">
        ...
        <div className="flex shrink-0 items-center gap-1">
          <button
            ...
            className="rounded-md border border-violet-300/70 px-2 py-1 text-[11px] font-medium text-violet-800 transition-colors hover:bg-violet-100/60 dark:border-violet-800 dark:text-violet-200"
          >
            Re-pin
          </button>
          <button
      ...
      <div className="mt-2 grid grid-cols-3 gap-2 text-center text-[11px] text-violet-900 dark:text-violet-100">
      ...
      {comparison.topChanged && (
        <div className="mt-2 text-[11px] text-violet-900 dark:text-violet-100">
      ...
      {comparison.topMovers.length > 0 ? (
        <div className="mt-2 space-y-1">
          {comparison.topMovers.map((mover) => (
            <div key={mover.id} className="flex items-center justify-between gap-2 text-[11px]">
        ...
        <div className="mt-2 text-[11px] text-violet-800/80 dark:text-violet-200/80">
