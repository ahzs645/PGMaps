...
export function ScoreBuilderMobileRegionCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 grid grid-cols-2 gap-x-2 gap-y-1 text-xs text-cyan-800 dark:text-cyan-200">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        <button
          ...
          className="min-h-10 rounded-md border border-cyan-400/70 bg-white/70 px-3 py-2 text-xs font-medium text-cyan-900 transition-colors hover:bg-white dark:border-cyan-800 dark:bg-cyan-950/20 dark:text-cyan-100"
        >
          View Insight
        </button>
        <button
          ...
          className={cn(
            'min-h-10 rounded-md border px-3 py-2 text-xs transition-colors',
            pinned
        ...
        <button
          type="button"
          onClick={onClose}
          className="min-h-10 rounded-md border border-cyan-300/70 px-3 py-2 text-xs text-cyan-800 transition-colors hover:bg-cyan-100/70 dark:border-cyan-900 dark:text-cyan-300 dark:hover:bg-cyan-950/40"
        >
          Clear
        </button>
      </div>
