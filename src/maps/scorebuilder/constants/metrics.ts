...
const SCORE_METRIC_BASES: ScoreMetricBaseDefinition[] = [
  ...
  },
  {
    ...
    description: 'Precomputed balanced community walkability score. Only populated on the PG Community boundary.',
    format: 'count',
    category: 'walkability',
  },
  {
    ...
    description: 'Precomputed infrastructure-weighted community walkability score. PG Community boundary only.',
    format: 'count',
    category: 'walkability',
  },
  {
    ...
    description: 'Precomputed access-weighted community walkability score. PG Community boundary only.',
    format: 'count',
    category: 'walkability',
  },
  {
    ...
    description: 'Precomputed safety-adjusted community walkability score. PG Community boundary only.',
    format: 'count',
    category: 'walkability',
  },
  {
    ...
    description: 'Precomputed supplemented-local community walkability score. PG Community boundary only.',
    format: 'count',
    category: 'walkability',
  },
  {
...
const METRIC_CAVEATS: Partial<Record<ScoreMetricKey, string>> = {
  ...
  communityWalkBalanced: 'Precomputed walkability variant; only populated on the PG Community boundary.',
  communityWalkInfrastructure: 'Precomputed walkability variant; only populated on the PG Community boundary.',
  communityWalkAccess: 'Precomputed walkability variant; only populated on the PG Community boundary.',
  communityWalkSafetyAdjusted: 'Precomputed walkability variant; only populated on the PG Community boundary.',
  communityWalkSupplementedLocal: 'Precomputed walkability variant; only populated on the PG Community boundary.',
