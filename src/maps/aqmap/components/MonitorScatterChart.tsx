...
export function MonitorScatterChart({
  ...
  return (
    ...
    >
      {chartWidth > 0 && (
        <ScatterChart width={chartWidth} height={height} margin={CHART_MARGIN}>
          ...
          <XAxis
            ...
            axisLine={false}
            tickLine={false}
            label={{ value: xLabel, position: 'insideBottom', offset: -14, fill: 'hsl(var(--muted-foreground))', fontSize: 10 }}
          />
          <YAxis
            type="number"
            dataKey="y"
