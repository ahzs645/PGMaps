...
const EN: StringMap = {
  ...
  'sidebar.colorScheme': 'Marker Colors',
  'colorScheme.aqhi': 'AQHI',
  'colorScheme.slate': 'Blue-gray',
...
const FR: StringMap = {
  ...
  'sidebar.colorScheme': 'Couleurs des icônes',
  'colorScheme.aqhi': 'IQA',
  'colorScheme.slate': 'Gris-bleu',
