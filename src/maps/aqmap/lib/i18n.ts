...
const EN: StringMap = {
  ...
  'ring.shape': 'Shape',
  'ring.shape.donut': 'Donut',
  'ring.shape.pie': 'Pie',
  'ring.number': 'Count',
  'ring.number.on': 'Show',
  'ring.number.off': 'Hide',
  'ring.shadow': 'Shadow',
  'ring.shadow.on': 'Show',
  'ring.shadow.off': 'Hide',
  'ring.center': 'Center',
  'ring.center.white': 'White',
  'ring.center.transparent': 'Transparent',
  ...
  'overlay.renderMode': 'Render mode',
...
const FR: StringMap = {
  ...
  'ring.style': 'Style d’anneau',
  'ring.shape': 'Forme',
  'ring.shape.donut': 'Anneau',
  'ring.shape.pie': 'Camembert',
  'ring.number': 'Nombre',
  'ring.number.on': 'Afficher',
  'ring.number.off': 'Masquer',
  'ring.shadow': 'Ombre',
  'ring.shadow.on': 'Afficher',
  'ring.shadow.off': 'Masquer',
  'ring.center': 'Centre',
  'ring.center.white': 'Blanc',
  'ring.center.transparent': 'Transparent',
  ...
  'overlay.deckgl': 'deck.gl',
  'overlay.renderMode': 'Mode de rendu',
