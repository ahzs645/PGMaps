    ...
    details:
      sourceKey === 'bcEnviroScreenReconstruction'
        ? [
            ...
            'The current reconstruction has all-BC correlation 0.958348; Prince George scores 57.581667 versus the displayed Shiny benchmark of 57.6.',
            'The industrial-sites input now uses the complete current NRCan source family and remains a paper-vintage proxy. Correlation is validation evidence, not proof that every source vintage is exact.',
            'Climate inputs remain benchmark-derived gaps and several other inputs remain proxies.',
          ]
        : [
    ...
    catalogMetrics:
      sourceKey === 'bcEnviroScreenReconstruction'
        ? [
            ...
            { label: 'Validation r', value: '0.958348' },
          ]
        : [
